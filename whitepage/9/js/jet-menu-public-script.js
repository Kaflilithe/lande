			...
			Vue.component('mobile-menu-item', {
				...
				computed: {
					itemClasses: function () {
						let itemClasses = ['jet-mobile-menu__item', 'jet-menu-item-' + this.itemDataObject.itemId, 'jet-mobile-menu__item--sub-trigger-' + (this.menuOptions.subTrigger || 'item'),];
			...
			Vue.component('mobile-menu', {
				...
				computed: {
					instanceClass: function () {
						let classes = ['jet-mobile-menu__instance', 'jet-mobile-menu__instance--' + this.menuOptions.menuLayout + '-layout', this.menuOptions.menuPosition + '-container-position', (this.menuOptions.togglePosition || 'default') + '-toggle-position',];
						return classes;
					},
